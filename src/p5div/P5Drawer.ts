...
export type P5DrawDataFunc<TContext extends IP5TimeContext = P5TimeContext, TData=any> = (
  p: p5,
  ctx: TContext,
  data: TData
) => string;

export class P5DataDrawer<TData=any, TContext extends IP5TimeContext = IP5TimeContext> extends P5Drawer<TContext>
  implements IP5Item<TContext>
{

  constructor(public data:TData, private dataDrawer: P5DrawDataFunc<TContext>) {
    const drawer: P5DrawFunc<TContext>
     = ( p: p5,
      ctx: TContext
